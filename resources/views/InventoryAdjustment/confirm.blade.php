            ...
            <div class="detail-area">
                <table class="detail-table">
                    ...
                    <tr>
                        ...
                        <td class="text-center"><input type="number" id="inventory-unit-num-{{$inventoryManageData['supply_slip_detail_id']}}" name="data[InventoryManage][{{$inventoryManageData['supply_slip_detail_id']}}][unit_num]" value="{{$inventoryManageData['unit_num']}}"
                                readonly></td>
