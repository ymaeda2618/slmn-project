        ...
        <form class="smn-form" id="order-supply-unit-price-create-form" method="post" action="./OrderSupplyUnitPriceRegister" enctype="multipart/form-data" onsubmit="return inputCheck();">
            ...
            <div class="form-group">
                <div class="apply_from_box">
                    ...
                    <input type="date" class="form-control " id="apply_from " name="data[OrderSupplyUnitPrice][apply_from]" value="<?php echo date('Y-m-d');?>">
                </div>

                <div class="apply_to_box">
                    <label class="column-label" for="apply_to">適用終了日</label>
                    <input type="date" class="form-control " id="apply_to " name="data[OrderSupplyUnitPrice][apply_to]" value="<?php echo date('Y-m-d');?>">
                </div>
            </div>
            ...
            <table class="product-table">
                ...
                <tr id="product-upper-0">
                    ...
                    {{-- 担当 START --}}
                    <td class="width-10">
                        <input type="text" class="form-control staff_code_input" id="staff_code_0" name="data[OrderSupplyUnitPriceDetail][0][staff_code]" value="1009" tabindex="5">
                        <input type="hidden" id="staff_id_0" name="data[OrderSupplyUnitPriceDetail][0][staff_id]" value="9">
                    </td>
                    <td class="width-20">
                        <input type="text" class="form-control" id="staff_text_0" name="data[OrderSupplyUnitPriceDetail][0][staff_text]" placeholder="担当欄" value="石塚 貞雄" readonly>
                    </td>
                    {{-- 担当 END --}}
                    {{-- 削除 START --}}
                    <td class="width-5">
