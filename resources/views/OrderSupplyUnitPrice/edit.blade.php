        ...
        <form class="smn-form" id="order-supply-unit-price-create-form" method="post" action="./../OrderSupplyUnitPriceEditRegister" enctype="multipart/form-data" onsubmit="return inputCheck();">
            ...
            <table class="product-table">
                ...
                <tr id="product-upper-{{$orderSupplyUnitPriceDetails->order_supply_unit_price_detail_id}}">
                    ...
                    {{-- 担当者 START --}}
                    <td class="width-10">
                        <input type="text" class="form-control staff_code_input" id="staff_code_{{$orderSupplyUnitPriceDetails->order_supply_unit_price_detail_id}}" name="data[OrderSupplyUnitPriceDetail][{{$orderSupplyUnitPriceDetails->order_supply_unit_price_detail_id}}][staff_code]"
                            value="{{$orderSupplyUnitPriceDetails->staff_code}}" tabindex="6">
                    ...
                    <td class="width-20">
                        <input type="text" class="form-control" id="staff_text_{{$orderSupplyUnitPriceDetails->order_supply_unit_price_detail_id}}" name="data[OrderSupplyUnitPriceDetail][{{$orderSupplyUnitPriceDetails->order_supply_unit_price_detail_id}}][staff_text]" value="{{$orderSupplyUnitPriceDetails->staff_name}}"
