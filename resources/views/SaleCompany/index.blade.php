        ...
        <div class='list-area'>
            <table class='index-table '>
                <tbody>
                    ...
                    <tr>
                        <td>{{$saleCompanies->code}}</td>
                        <td>{{$saleCompanies->sale_company_name}}</td>
                        @if($saleCompanies->closing_date == 99)
                        <td>月末</td>
                        @elseif($saleCompanies->closing_date == 88)
                        <td>都度</td>
                        @else
                        <td>{{$saleCompanies->closing_date}}日</td>
                        @endif
                        @if (Home::authOwnerCheck()) <td><a class='edit-btn' href='./SaleCompanyEdit/{{$saleCompanies->sale_company_id}}'>編集</a></td> @endif
                    </tr>
                    @endforeach
                </tbody>
            </table>
