    ...
    <div class="row justify-content-center">
        ...
        <form class="event-form" id="event-create-form" method="post" action="../SaleShopConfirm" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type='hidden' id='sale_company_id_selected' value='{{$editSaleShop->sale_company_id}}'>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="postal_code" name="data[SaleShop][postal_code]" value="{{$editSaleShop->postal_code}}">
            </div>
            <div class="form-group">
                <label class="column-label" for="address">住所</label>
                <input type="text" class="form-control" id="address" name="data[SaleShop][address]" value="{{$editSaleShop->address}}">
            </div>
            <br>
            <button id="create-submit-btn" type="submit" class="btn btn-primary">編集確認画面へ</button>
            <input type='hidden' name="data[SaleShop][sale_shop_id]" value="{{$editSaleShop->sale_shop_id}}">
