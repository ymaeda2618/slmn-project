...
<div class="container">
    ...
    <div class="row justify-content-center">
        ...
        <div class="top-title">スタッフ編集画面</div>
        ...
        <form class="event-form" id="event-create-form" method="post" action="../StaffConfirm" enctype="multipart/form-data" onsubmit="return inputCheck();">
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" id="code" name="code" value="{{$editStaff->code}}">
            </div>
            <div class="form-group">
                <label class="column-label" for="staff_name_sei">スタッフ-姓</label>
                <input type="text" class="form-control" id="staff_name_sei" name="staff_name_sei" value="{{$editStaff->staff_name_sei}}">
            </div>
            <div class="form-group">
                <label class="column-label" for="staff_name_mei">スタッフ-名</label>
                <input type="text" class="form-control" id="staff_name_mei" name="staff_name_mei" value="{{$editStaff->staff_name_mei}}">
            </div>
            <div class="form-group">
                <label class="column-label" for="staff_yomi_sei">スタッフ-ヨミガナ-姓</label>
                <input type="text" class="form-control" id="staff_yomi_sei" name="staff_yomi_sei" value="{{$editStaff->staff_yomi_sei}}">
            </div>
            <div class="form-group">
                <label class="column-label" for="staff_yomi_mei">スタッフ-ヨミガナ-名</label>
                <input type="text" class="form-control" id="staff_yomi_mei" name="staff_yomi_mei" value="{{$editStaff->staff_yomi_mei}}">
            </div>
            <div class="form-group">
                ...
                <input type='hidden' id='staff_position_selected' value='{{$editStaff->staff_position_id}}'>
            </div>
            <br>
