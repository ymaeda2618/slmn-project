        ...
        <form class="smn-form" id="supply-slip-create-form" method="post" action="./../editRegisterSupplySlips" enctype="multipart/form-data" onsubmit="return inputCheck();">
            ...
            <table class="slip-data-table">
                ...
                <tr id="slip-upper-{{$SupplySlipDetails->sort}}">
                    <td class="index-td-blue" rowspan="2">{{$SupplySlipDetails->sort}}</td>
                    <td colspan="2">
                    ...
                    <td>
                        ...
                        <input type="number" class="form-control" id="inventory_unit_num_{{$SupplySlipDetails->sort}}" name="data[SupplySlipDetail][{{$SupplySlipDetails->sort}}][inventory_unit_num]" value="{{$SupplySlipDetails->inventory_unit_num}}" {{$readonly}} tabindex="{{$tabInitialNum + 2}}">
                    </td>
                    <td>
