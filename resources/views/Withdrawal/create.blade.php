        ...
        <form class="smn-form" id="withdrawal-create-form" method="post" action="./registerWithdrawal" enctype="multipart/form-data" onsubmit="return submitCheck();">
            ...
            <table class="withdrawal-table">
                <tr>
                    ...
                    <td>
                        <input type="text" class="form-control staff_code_input" id="staff_code" name="data[Withdrawal][staff_code]" value="1009" tabindex="6">
                        <input type="hidden" id="staff_id" name="data[Withdrawal][staff_id]" value="9">
                    </td>
                    <td class="width-30">
                        <input type="text" class="form-control" id="staff_text" name="data[Withdrawal][staff_text]" value="石塚 貞雄" readonly>
                    </td>
                </tr>
                <tr>
                    <th>支払金額</th>
