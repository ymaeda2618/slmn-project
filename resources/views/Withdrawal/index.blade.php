                        ...
                        <tr>
                            <td>
                                ...
                                <div class="table-td radio_box">
                                    <label class="radio-label"><input type="radio" name="data[Withdrawal][date_type]" value="1" {{$check_str_slip_date}}> 伝票日付</label>
                                    <label class="radio-label"><input type="radio" name="data[Withdrawal][date_type]" value="2" {{$check_str_withdrawal_date}}> 支払日付</label>
                                </div>
                                <div class="table-td">
                                    <input type="date" class="search-control" id="withdrawal_date_from" name="data[Withdrawal][withdrawal_date_from]" value="{{$condition_date_from}}" tabindex="1">
                                </div>
                                <div class="table-td">
                                    <input type="date" class="search-control" id="withdrawal_date_to" name="data[Withdrawal][withdrawal_date_to]" value="{{$condition_date_to}}" tabindex="2">
                                </div>
                            </td>
                        </tr>
                        <tr>
...
(function($) {
        jQuery(window).load(function() {
            ...
            $(document).on("blur", "input", function(event) {
                ...
                if (selector_code.match(/withdrawal_company/)) { // 仕入先企業
